...
import model.gestaoProdutos.Livro;
import model.gestaoProdutos.Produto;
import model.gestaoProdutos.Estoque;

public class LH extends javax.swing.JFrame implements ActionListener{

    private Livro produto;
    private Livro livro;
    private Estoque arquivosProdutos;
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == getjBCadastrar()){
            ...
            livro.setNome(produto.getNome());
            livro.setCodigo(produto.getCodigo());
            livro.setQtdEmEstoque(produto.getQtdEmEstoque());
            livro.setPreco(produto.getPreco());
         
            livro.setEditora(getjFISBN().getText());
            livro.setISBN(getjFISBN().getText());
            livro.setAutor(getjTAutor().getText());
            livro.setAnoPublicacao(Integer.parseInt(getjTAno().getText()));
