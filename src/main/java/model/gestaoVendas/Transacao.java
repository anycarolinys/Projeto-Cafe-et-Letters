...
public class Transacao implements ManipulacaoVenda {
 ...
 public boolean cadastrarCompra(Cliente cliente, Compra compra) {
    ...
    public void tirarProdutoEstoque(Produto produto) {

        String classeProduto = produto.getClass().getSimpleName().toLowerCase();
        String nomeArquivo = Integer.toString(produto.hashCode());
        File arquivoProduto = new File("./src//main/java/model/gestaoProdutos/produtosForaEstoque" + "/" + nomeArquivo + ".txt");
    ...
    public boolean diminuirEstoque(String caminhoArquivo, int qtdComprada) {
    ...
    public boolean alterarArquivoTexto(Produto produto, int qtdComprada) {
